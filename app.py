...
# CORS configuration
CORS(app, supports_credentials=True, origins=['http://127.0.0.1:*', 'http://localhost:*', 'https://srabyte.com:*', 'https://www.srabyte.com:*', 'https://sunilkumarchoudari.github.io/srabyte-server:*', 'https://sunilkumarchoudari.github.io:*', 'https://github.com:*'])
